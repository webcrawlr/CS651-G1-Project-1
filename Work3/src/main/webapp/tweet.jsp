...
<form id="storegae" action="GaeStore" method="get" name="storegae"  >
	<td><textarea id="text_content" name="text_content" class="textarea"
							placeholder="TYPE HERE (AS FRIEND)" style="width:96%;height:90px;background-color:gold;color:olive;border:none;padding:2%;font:22px/30px sans-serif;"></textarea></td>
	<input type=hidden id=user_id name= "friend2all" />
	<input type=hidden id=first_name name="Mr."  />
	<input type=hidden id=last_name name="Rogers"  />
	<input type=hidden id=picture name=picture  />
